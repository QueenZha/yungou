...
<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form action="addServlet" method="post" class="form-horizontal" id="myForm2">
						  <fieldset>
							<div class="control-group">
							  <label class="control-label" for="typeahead">用户名 </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="loginName" id="typeahead" >
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead1">真实姓名 </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="userName" id="typeahead1" >
							  </div>
							   <div class="control-group">
								<label class="control-label">性别</label>
								<div class="controls">
								  <label class="radio">
									<input type="radio" name="sex" id="optionsRadios1" value="1" checked="checked">
									男
								  </label>
							...
							<div class="control-group">
							  <label class="control-label" for="typeahead2">身份证号码 </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="identityCode" id="typeahead2" >
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead3">邮箱 </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="email" id="typeahead3" >
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead4">手机号码 </label>
							  <div class="controls">
								<input type="text" class="span6 typeahead" name="mobile" id="typeahead4" >
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead5">密码 </label>
							  <div class="controls">
								<input type="password" class="span6 typeahead" name="password" id="typeahead5" >
							  </div>
							</div>
							<div class="control-group">
							  <label class="control-label" for="typeahead6">确认密码 </label>
							  <div class="controls">
								<input type="password" class="span6 typeahead" name="reppassword" id="typeahead6" >
							  </div>
							</div>
