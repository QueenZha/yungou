	...
	<div class="row-fluid sortable">
		<div class="box span12">
			<div class="box-header well" data-original-title>
				<h2>
					<i class="icon-user"></i>
					当前登录用户名:${sessionScope.loginUser.loginName}
				</h2>
				<div class="box-icon">
					<a href="#" class="btn btn-setting btn-round"><i
						class="icon-cog"></i> </a> <a href="#"
						class="btn btn-minimize btn-round"><i class="icon-chevron-up"></i>
					...
					<tbody>
						<c:forEach items="${userList}" var="user">
							<tr>
								...
								<td class="center"><span class="label label-success">${user.mobile}</span>
								</td>
								<td class="center"><a class="btn btn-success" href="#">
										<i class="icon-zoom-in icon-white"></i> 详情 </a> <a
									class="btn btn-info" href="updateUser?id=${user.id}&method=findById"> <i
										class="icon-edit icon-white"></i> 修改 </a> <a
									class="btn btn-danger" href="javascript:del('deleteServlet?id=${user.id}');"> <i
