<%@page import="bdqn.service.impl.UserServiceImpl"%>
<%@page import="bdqn.service.UserService"%>
<%@page import="bdqn.entity.EasyBuy_User"%>
...
<header id="pc-header">
	<div class="pc-header-nav">
		<div class="navbar-collapse collapse in navbar-header pc-header-con">
			<div class="fl pc-header-link" >您好！，欢迎来云购物 <a href="login.jsp" target="_self">请登录</a> <a href="register.jsp" target="_self"> 免费注册</a></div>
	...
	<div class="pc-header-logo clearfix">
		...
		<div class="fr pc-head-car">
			<i class="icon-car"></i>
			<a href="my-car.jsp" target="_self">我的购物车</a>
			<em>0</em>
		</div>
	</div>
	<!--  顶部    start-->
